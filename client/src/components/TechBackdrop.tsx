/** Decorative tech × anime atmosphere — pointer-events none */
    ...
    <div className="tech-backdrop" aria-hidden="true">
      ...
      <svg className="tech-backdrop__circuit" viewBox="0 0 200 120" preserveAspectRatio="none">
        <path
          ...
          fill="none"
          stroke="rgba(61,232,255,0.22)"
          strokeWidth="1.2"
        />
        <circle cx="60" cy="20" r="2.5" fill="rgba(61,232,255,0.55)" />
        <circle cx="110" cy="50" r="2.5" fill="rgba(255,123,156,0.5)" />
        <circle cx="160" cy="30" r="2.5" fill="rgba(255,213,106,0.55)" />
        <circle cx="90" cy="90" r="2.5" fill="rgba(61,232,255,0.45)" />
        <circle cx="150" cy="60" r="2.5" fill="rgba(255,123,156,0.4)" />
      </svg>
      <svg className="tech-backdrop__circuit tech-backdrop__circuit--br" viewBox="0 0 200 120" preserveAspectRatio="none">
        <path
          ...
          fill="none"
          stroke="rgba(255,123,156,0.2)"
          strokeWidth="1.2"
        />
        <circle cx="140" cy="100" r="2.5" fill="rgba(61,232,255,0.4)" />
        <circle cx="90" cy="70" r="2.5" fill="rgba(255,213,106,0.4)" />
        <circle cx="110" cy="25" r="2.5" fill="rgba(255,123,156,0.45)" />
      </svg>
    </div>
  );
}
